...
import QandA from '../src/components/QuestionsAndAnswers/QuestionsAndAnswers.jsx';
// import QandASearch from '../src/components/QuestionAndAnswers/QandASearch.jsx';
// import QuestionItem from '../src/components/QuestionAndAnswers/QuestionItem.jsx';
// import AnswerItem from '../src/components/QuestionAndAnswers/AnswerItem.jsx';
...
describe('Questions and Answers Component', () => {
  test('QuestionAndAnswers is rendered to the page', () => {
    render(<QandA info={fillerQandA} />);
    const stuff = screen.getByText(/Questions and Answers/i);
